...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($serial === "") {
        ...
        // Aquí puedes poner la lógica para reimprimir la etiqueta QR
...
<head>
    <meta charset="UTF-8">
    <title>Reimprimir etiqueta QR</title>
    <style>
        body {
            background: #aad3f0;
    ...
    <script>
        // Función ejemplo para confirmar baja
